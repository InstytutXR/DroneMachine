...
namespace DerelictComputer
{
    ...
    {
        [SerializeField, Range(0.125f, 4f)] private double _lfoCycleMultiplier = 1;
        [SerializeField, Range(20f, 1000f)] private double _baseFrequency = 80;
        ...
        [SerializeField, Range(0.25f, 4f)] private double _attackPulses = 0.25;
        [SerializeField, Range(0f, 8f)] private double _sustainPulses = 0.5;
        [SerializeField, Range(0.25f, 4f)] private double _releasePulses = 0.25;
        ...
        private void Awake()
        {
            ...
            Oscillator1.SetFrequency(MusicMathUtils.SemitonesToPitch(_osc1Pitch) * _baseFrequency);
            Oscillator1.SetWaveformAmount(_osc1Tone);

            Oscillator2.Init();
            Oscillator2.Reset();
            Oscillator2.SetVolume(_osc2Volume);
            Oscillator2.SetFrequency(MusicMathUtils.SemitonesToPitch(_osc2Pitch) * _baseFrequency);
            Oscillator2.SetWaveformAmount(_osc2Tone);

            Oscillator3.Init();
            Oscillator3.Reset();
            Oscillator3.SetVolume(_osc3Volume);
            Oscillator3.SetFrequency(MusicMathUtils.SemitonesToPitch(_osc3Pitch) * _baseFrequency);
